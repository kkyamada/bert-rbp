...
class BertRNARBPConfig(PretrainedConfig):
    r"""
        This is the configuration class to store the configuration of a :class:`~transformers.BertModel`.
        It is used to instantiate an BERT model according to the specified arguments, defining the model
        architecture.
    ...
    def __init__(
        ...
        rnn_hidden=768,
        rnn="lstm",
        conv1d_in_channels=1,
        conv1d_out_channels=1,
        conv1d_padding=0,
        conv1d_dilation=1,
        conv1d_kernel_size=513,
        conv1d_stride=1,
        **kwargs
    ):
        super().__init__(**kwargs)
        ...
        self.rnn_dropout = rnn_dropout
        self.rnn_hidden = rnn_hidden
        self.conv1d_in_channels = conv1d_in_channels
        self.conv1d_out_channels = conv1d_out_channels
        self.conv1d_padding = conv1d_padding
        self.conv1d_dilation = conv1d_dilation
        self.conv1d_kernel_size = conv1d_kernel_size
        self.conv1d_stride = conv1d_stride